...
_test_contains "LUKS TPM binding"             "$_json" '"name":"LUKS TPM binding"'
_test_contains "LUKS Secure Boot binding"     "$_json" '"name":"LUKS Secure Boot binding"'
_test_contains "LUKS boot chain binding"      "$_json" '"name":"LUKS boot chain binding"'
