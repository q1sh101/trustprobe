...
#define SUBGROUP_REMAINING(sg) \
    (TRUSTPROBE_MAX_SUBGROUP_RESULTS - (sg)->result_count)
...
static void subgroup_finalize(check_subgroup_t *sg) {
    for (size_t i = 0; i < sg->result_count; i++) {
        trustprobe_summary_add(&sg->summary, &sg->results[i]);
    }
}
...
static const subgroup_def_t physical_subgroups[] = {
    {"usbguard",       {trustprobe_check_usbguard, trustprobe_check_usbguard_policy, NULL}},
    {"desktop usb",    {trustprobe_check_desktop_usb, NULL}},
    {"iommu",          {trustprobe_check_iommu, NULL}},
    {"thunderbolt",    {trustprobe_check_bolt, NULL}},
    {"bluetooth",      {trustprobe_check_bluetooth, NULL}},
    {"platform debug", {trustprobe_check_dci, NULL}},
    {"serial console", {trustprobe_check_serial_console, NULL}},
    {NULL, {NULL}},
};

static const subgroup_def_t firmware_subgroups[] = {
    {"efi",               {trustprobe_check_efi, NULL}},
    {"secure boot",       {trustprobe_check_sbctl, trustprobe_check_secureboot, NULL}},
    {"boot chain",        {trustprobe_check_bios_boot, trustprobe_check_boot_chain, NULL}},
    {"esp",               {trustprobe_check_esp_posture, NULL}},
    {"tpm",               {trustprobe_check_tpm, NULL}},
    {"luks",              {trustprobe_check_luks, NULL}},
    {"platform firmware", {trustprobe_check_bios_cntl, trustprobe_check_me_version, NULL}},
    {"microcode",         {trustprobe_check_microcode, NULL}},
    {"fwupd",             {trustprobe_check_fwupd, NULL}},
    {NULL, {NULL}},
};
